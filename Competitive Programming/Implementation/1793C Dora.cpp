...
void solve()
{
    ...
    int low = 1, high = n;
    int minimum = 1, maximum = n; //% Numbers are lying in range [1, n] hence min = 1, max = n

    /*
    & Traverse using two pointers assume this testcase
    [1 3 2 4 6 5 7] let us assume low = 1, high = 7 (1 based indexing)
    & At a[1] and a[7] we have min = 1, max = 7 so we update low and high
    & At a[2] and a[6] we have elements as 3,5 but min=2 and max = 6 hence we do not perform any update

    & as soon as we get a condition where we can't perform any update simply break and return {low, high} and if low>=high then "-1"
