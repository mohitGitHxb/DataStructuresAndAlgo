...
million subscribers on Mathub! So the website decided to send him a personalized award — The Mathhub's Bit Button!

The Bit Button is a rectangular table with n
rows and m columns with 0 or 1

in each cell. After exploring the table Madoka found out that:

    A subrectangle A

is contained in a subrectangle B if there's no cell contained in A but not contained in B
.
...
@ Key observation :
& any 4x4 cell containing 3 1's is and 1 zero will cause intersection of two nice subrectangles
* O(N*M*16)
 */
