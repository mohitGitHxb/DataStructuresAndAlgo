...
;
for each i
from 1 to n, replace ai with ai mod k†

    .

Find a value of k
such that 1≤k≤1018 and the array a1,a2,…,an contains exactly 2 distinct values at the end of the operation. It can be shown that, under the constraints of the problem, at least one such k
...
{
    /*
    @ TIPS FOR CONSTRUCTIVE ALGORITHMS
    & Prepare a brute force script and just add testcases to get a definite pattern
