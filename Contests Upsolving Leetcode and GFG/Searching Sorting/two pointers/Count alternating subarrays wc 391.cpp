...
public:
    ...
    ll countAlternatingSubarrays(vi &nums)
    {
        ll subarrays = 0;
        ...
        forn(i, sz(nums))
        {
            ...
            {
                lastOccurrence = i - 1; // get to know where numbers weren't adjacent as right as possible
            }
            subarrays += (i - lastOccurrence); // subarrays ending at index i including element at index i
        }
        return subarrays;
    }
};
